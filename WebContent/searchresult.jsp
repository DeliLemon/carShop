...
<link
	...
	rel="stylesheet">
<link
	href="http://fonts.googleapis.com/css?family=Roboto+Condensed:400,700"
	rel="stylesheet">
</head>
<body onload="loginStatus()">
			...
			<div class="row">
				...
				<div class="col-sm-6 top-left">
					<ul>
						...
						<li><div class="lo-Re_status">
								<a href="LoginUI/login.html" class="L_R">登录</a>
							</div></li>
						<li><div class="lo-Re_status">
								<a href="RegisterUI/register.html" class="L_R">注册</a>
							</div></li>
						<li class="nav-item dropdown">
							<div id="userstatus">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
									role="button" data-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false">您好，${userName} </a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<li><div id="leave" style="display: none;">
											<a href="Leave">退出</a>
										</div></li>
								</div>
							</div>
			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<ul class="navbar-nav">
					<li class="nav-item "><a class="nav-link active"
						href="carType.jsp">车型 <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a href="" class="nav-link">购车指南</a></li>
					<li class="nav-item"><a href="" class="nav-link">客户服务</a></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						role="button" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false"> 热款 </a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
	...
	<form name="answer" action="Display" method="get"> 
		<ul class="container-ul" id="searchresult-container">
			...
			<div class="col-md-4 w3layouts_footer_grid">
				...
				<ul class="con_inner_text">
					<li><span class="fa fa-map-marker" aria-hidden="true"></span>1234k
						Avenue, 4th block, <label> New York City.</label></li>
					<li><span class="fa fa-envelope" aria-hidden="true"></span> <a
						href="mailto:info@example.com">info@example.com</a></li>
					<li><span class="fa fa-phone" aria-hidden="true"></span> +1234
						567 567</li>
				</ul>
			</div>
		</div>
	...
	<!--js working-->
	<script>
		var cars='${searchResult}';
		var ul=document.getElementById("searchresult-container");
		var li="";
		if(cars==""){
			alert("查询结果为空");
		}else{
			var carRe=cars.split("**");
			var index=0;
			while(index < carRe.length-1){
				var car=carRe[index].split("#");
				li+="<li><div><img src='images/"+car[1]+".png' height='160px'></div><div >"+car[1]
				+"</div><input type=submit value='详情' onclick='detial()' class='search-container-input-button'></input>"+
				"<input type=hidden name='carName'value='"+car[1]+"' > </li>";
				index++;
			}
			ul.innerHTML=li;
		}
