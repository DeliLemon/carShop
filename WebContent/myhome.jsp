...
<body onload="loginStatus()">
 ...
 <section class="buy_container">
 	<div class="wthree_head_section">
		<h2 class="w3l_header">我的空间 </h2>
		<p>信息管理</p>
	</div>
 	<div class="grid_3 grid_5 w3ls">
 		<div align="right"><button id="edit" style="color:red;" >修改</button></div>
 		<form action="UserHome" method="post">
 			<h3>账号</h3>
				<div class="alert alert-success" role="alert">
				  <input type="text" value='${userID}'  name="userID" readOnly="true"></input>
				</div>
			<h3>用户名</h3>
				<div class="alert alert-success" role="alert">
				  <input type="text" class="myhome-inputtext" value=<%=user.getUserName() %> name="userName" readOnly="true"></input>
				</div>
			<h3>真名</h3>
				<div class="alert alert-success" role="alert">
				  <input type="text" class="myhome-inputtext" value=<%=user.getUserRealName() %> name="userRealName" readOnly="true"></input>
				</div>
			<h3>收货地址</h3>
				<div class="alert alert-info" role="alert">
				  	<input type="text" class="myhome-inputtext" value=<%=user.getUserHome() %> name="userHome" readOnly="true"></input>
				</div>
			<h3>手机号码</h3>
				<div class="alert alert-info" role="alert">
				   	<input type="text" class="myhome-inputtext" value=<%=user.getUserPhone() %> name="userPhone" readOnly="true"></input>
				</div>
			<h3>邮箱</h3>
				<div class="alert alert-success" role="alert">
				  <input type="text" class="myhome-inputtext" value=<%=user.getUserEMail() %> name="userEMail" readOnly="true"></input>
				</div>
			<div style="text-align:right; margin-top:50px;">
				<input type="submit" id="submitBtn" class="btn btn-secondary" style="width:100px;" value="确定" disabled="true"></input>
			</div>
		</form>
	</div>
 </section>
		...
		$(document).ready(function() {
			...
			$("#edit").click(function(){
				$("#submitBtn").attr("disabled",false);
				 var obj=$(".myhome-inputtext");
				for(var index=0;index < obj.length ;index++){
					obj[index].readOnly=false;
				}
			});
