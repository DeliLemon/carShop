...
<body onload="loginStatus()">
 ...
 <section class="buy_container">
 	...
 	<div class="grid_3 grid_5 w3ls">
 		<form action="Buy" method="get" name="multi_buyForm">
			<h3>收货人</h3>
			...
			<h3>商品名称</h3>
				<div class="alert alert-info" role="alert">
				   	<input type="text" value='${McarName}' name="carName"  readonly="true"></input>
				</div>
				<div class="alert alert-info" role="alert" style="display:none;">
				   	<input type="hidden" value=${Mcount} name="count"  readonly="true"s></input>
				</div>
			<h3>总价</h3>
				<div class="alert alert-info" role="alert">
				   	<input type="text" value=${Msum} name="sum" readonly="true"></input>
				</div>
